...
// ── Auto-hide idle delay choices (seconds) ────────────────────────────────────
// These match the combo choices in prefs.js.
export const AUTO_HIDE_DELAYS = [5, 15, 30, 0]; // 0 = never
